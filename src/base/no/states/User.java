...
public class User {
  ...
  // about the group where this worker belongs in the company.(Permissions, actions, schedule, etc).
  ...
  public boolean hasAccess(Area areaToAcces, LocalDate date, LocalTime hour,
                           String action, ArrayList<String> reason) {
    ...
    //At the beginning of the first iteration of this function
    // is null, because once it's executed it will get the first
